...
{`${this.convertSecondsToCalendarDate()}`}
   ...
   this.state.fontLoaded ? (
    ...
    {`${this.convertSecondsToCalendarDate()}`}
        ...
        <Image source={require('./assets/weather2bbq.png')} style={{height: 75, width: 75 }}/>
        </TouchableOpacity>
      </View>
      ...
      <Text style={{fontSize: 17, color: 'white', paddingLeft: 20, paddingRight: 20, paddingTop: 10}}>Weather2BBQ - an app by <Text style={{fontSize: 17, color: '#FF0000'}} onPress={()=>Linking.openURL('https://github.com/jah1603')}>James Henderson</Text><Text style={{fontSize: 17, color: '#FF0000'}} onPress={()=>Linking.openURL('https://github.com/SFR1981')}>, Stephen Rooney</Text> &<Text style={{fontSize: 18, color: '#FF0000'}} onPress={()=>Linking.openURL('https://github.com/DavidAPears')}> David Pears.</Text> Weather2BBQ is part of the Weather2 series (see also Weather2Golf, Weather2Wed & Weather2Walk)</Text>
